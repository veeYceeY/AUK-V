...
set_property IOSTANDARD LVCMOS33 [get_ports {o_tx_0[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {i_rx_0[2]}]
...
set_property PACKAGE_PIN B19 [get_ports {o_tx_0[2]}]
set_property PACKAGE_PIN E17 [get_ports {i_rx_0[3]}]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {example_led_i/LEDS[0]} {example_led_i/LEDS[1]} {example_led_i/LEDS[2]}]]
...
connect_debug_port u_ila_1/clk [get_nets [list example_led_i/processing_system7_0/inst/FCLK_CLK0]]
