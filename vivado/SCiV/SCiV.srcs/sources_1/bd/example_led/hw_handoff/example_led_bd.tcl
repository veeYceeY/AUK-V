...
################################################################
# This is a generated script based on design: example_led
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: sciv_example_system_0, and set properties
  set block_name sciv_example_system
  set block_cell_name sciv_example_system_0
  if { [catch {set sciv_example_system_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $sciv_example_system_0 eq "" } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk] [get_bd_pins sciv_example_system_0/i_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins ila_0/probe1] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net sciv_example_system_0_o_port_b [get_bd_ports LEDS] [get_bd_pins ila_0/probe0] [get_bd_pins sciv_example_system_0/o_port_b]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins sciv_example_system_0/i_rst] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins sciv_example_system_0/i_port_a] [get_bd_pins xlconstant_0/dout]
