...
--Date        : Fri Sep  4 08:56:39 2020
--Host        : SCiMOS running 64-bit Ubuntu 20.04.1 LTS
--Command     : generate_target example_led.bd
--Design      : example_led
...
entity example_led is
  ...
  attribute core_generation_info of example_led : entity is "example_led,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=example_led,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute hw_handoff : string;
  attribute hw_handoff of example_led : entity is "example_led.hwdef";
end example_led;

architecture STRUCTURE of example_led is
  component example_led_processing_system7_0_0 is
  port (
  ...
  end component example_led_processing_system7_0_0;
  component example_led_util_vector_logic_0_0 is
  port (
    Op1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    Res : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component example_led_util_vector_logic_0_0;
  component example_led_clk_wiz_0_1 is
  port (
    resetn : in STD_LOGIC;
  ...
  end component example_led_clk_wiz_0_1;
  component example_led_ila_0_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 2 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component example_led_ila_0_0;
  component example_led_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 31 downto 0 )
  );
  end component example_led_xlconstant_0_0;
  component example_led_vio_0_0 is
  port (
    clk : in STD_LOGIC;
    probe_in0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe_out0 : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component example_led_vio_0_0;
  component example_led_sciv_example_system_0_0 is
  port (
    i_clk : in STD_LOGIC;
    i_rst : in STD_LOGIC;
  ...
  end component example_led_sciv_example_system_0_0;
  ...
  signal sciv_example_system_0_o_port_b : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  LEDS(2 downto 0) <= sciv_example_system_0_o_port_b(2 downto 0);
clk_wiz_0: component example_led_clk_wiz_0_1
     port map (
...
ila_0: component example_led_ila_0_0
     port map (
      clk => clk_wiz_0_clk_out1,
      probe0(2 downto 0) => sciv_example_system_0_o_port_b(2 downto 0),
      probe1(0) => util_vector_logic_0_Res(0)
    );
processing_system7_0: component example_led_processing_system7_0_0
     port map (
...
sciv_example_system_0: component example_led_sciv_example_system_0_0
     port map (
      i_clk => clk_wiz_0_clk_out1,
      i_port_a(31 downto 0) => xlconstant_0_dout(31 downto 0),
      i_rst => util_vector_logic_0_Res(0),
      o_port_b(2 downto 0) => sciv_example_system_0_o_port_b(2 downto 0)
    );
util_vector_logic_0: component example_led_util_vector_logic_0_0
     port map (
      Op1(0) => vio_0_probe_out0(0),
      Res(0) => util_vector_logic_0_Res(0)
    );
vio_0: component example_led_vio_0_0
     port map (
      clk => clk_wiz_0_clk_out1,
      probe_in0(0) => clk_wiz_0_locked,
      probe_out0(0) => vio_0_probe_out0(0)
    );
xlconstant_0: component example_led_xlconstant_0_0
     port map (
