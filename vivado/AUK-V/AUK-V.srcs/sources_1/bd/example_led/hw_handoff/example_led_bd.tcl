...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk] [get_bd_pins sciv_example_system_0/i_clk] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins ila_0/probe1] [get_bd_pins sciv_example_system_0/i_rst] [get_bd_pins util_vector_logic_0/Res]
